...
Insert them into two spatial regression lag models of your choice.
You can select variables and model of your own choice (f.e. `afd_share ~ immigrant_share + inhabitants` and Spatial Lag Y).
:::
