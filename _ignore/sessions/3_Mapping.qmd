...
![](../img/ggplot2.png){.r-stretch fig-align="center"}
...
![](../img/kermit-map.gif){.r-stretch fig-align="center"}
...
:::: columns
::: {.column width="50%"}
![](https://media.giphy.com/media/C9x8gX02SnMIoAClXa/giphy-downsized-large.gif){fig-align="center" width="60%"}
...
- choosing appropriate color schemes and fonts
- purpose and audience of the map should guide its layout
:::
::::
...
![](../img/ggplot-layers.png){.r-stretch fig-align="center"}
...
## Geometric objects: point layers
...
## Geometric objects: combining layers
...
## Exercise 3_1: Basic Maps💪 {.center style="text-align: center;"}

[Exercise](https://denabel.github.io/BIGSSS_geo_2026/exercises/3_1_Mapping.html)
...
## Exercise 3_2: Fun with Maps💪 {.center style="text-align: center;"}

[Exercise](https://denabel.github.io/BIGSSS_geo_2026/exercises/3_2_Fun_with_Maps.html)
